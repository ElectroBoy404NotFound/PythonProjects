...
def openFile():
    ...
    strTextFile = filedialog.askopenfilename(title="Open File in PyPad++", filetypes=(("Text Files", "*.txt"),))
...
# GUI.shortcuts
window.bind('<Control-o>', shortcutTrigger)
window.bind('<Control-s>', shortcutTrigger)
window.bind('<Control-q>', shortcutTrigger)
